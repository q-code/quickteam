...
if ( !qte_web_login('logged') )
{
  ...
  if ( !isset($_POST['usr']) || !isset($_POST['pwd']) )
  {
    ...
    echo '
    <form method="post" action="test_login_here.php">
  ...
  else
  {
    ...
    {
      echo '<p>Access denied... <a href="',$qte_root,'test_login_here.php">Try again</a></p>';
    }
...
{
  echo '<p>You are already logged in... <a href="',$qte_root,'test_login_here.php?logout">log out</a></p>';
}
