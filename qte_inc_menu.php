...
<option value="show_Z"'.($_SESSION[QT]['show_Z'] ? ' class="bold"' : '').'>'.$L['Show'].': '.$arr['Z']['statusname'].'</option>
<option value="hide_Z"'.(!$_SESSION[QT]['show_Z'] ? ' class="bold"' : '').'>'.$L['Hide'].': '.$arr['Z']['statusname'].'</option>
</optgroup>
</select>';
