...
We inform you that your child has registered on the website {$_SESSION[QT]['site_name']}.
...
The form can be accessed through this page: {$_SESSION[QT]['site_url']}/qte_form_coppa.php

Once the administrator has received this form via fax or regular mail the account will be activated.
